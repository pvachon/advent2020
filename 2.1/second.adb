...
procedure second is
    ...
    begin
        ...
        Ada.Text_IO.Put_Line("  Min: " & Integer'Image(min) &
            " Max: " & Integer'Image(max) &
            " Needle: " & needle &
            " Check: " & Boolean'Image(line(str_offs + min - 1) = needle or line(str_offs + max - 1) = needle) &
            " remaining: " & line(str_offs..line'Last));

        return line(str_offs + min - 1) = needle xor line(str_offs + max - 1) = needle;
    end Handle_Line;
